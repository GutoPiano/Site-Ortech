  ...
  <section id="faq" class="py-20 bg-gradient-to-br from-gray-50 to-white">
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
      ...
      <div class="mt-12 text-center">
        <p class="text-gray-600 mb-4">Não encontrou a resposta que procurava?</p>
        <a 
          href="https://wa.me/554133276453" 
          target="_blank"
          class="inline-flex items-center gap-2 bg-ortech-green hover:bg-emerald-800 text-white font-bold py-3 px-8 rounded-lg transition-all transform hover:scale-105"
        >
