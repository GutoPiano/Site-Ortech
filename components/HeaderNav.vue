<template>
  <header class="fixed top-0 left-0 right-0 bg-ortech-gold shadow-lg z-50">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      <div class="flex justify-between items-center py-4">
        <div class="flex items-center">
          <h1 class="text-3xl font-poppins font-bold text-white">
            ORTECH
          </h1>
        </div>
        ...
        <a 
          ...
          target="_blank"
          class="bg-ortech-green hover:bg-emerald-800 text-white font-bold py-2 px-6 rounded-lg transition-all transform hover:scale-105 flex items-center gap-2"
        >
